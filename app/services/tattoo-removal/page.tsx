...
export default function RemovalPage() {
  return <><Navbar /><main id="main-content">
    <section className="studio-section grid gap-10 pt-32 md:pt-40 lg:grid-cols-[1.5fr_1fr]">
      <div><p className="studio-eyebrow">Tattoo removal consultations</p><h1 className="mt-5 text-5xl font-medium leading-tight tracking-tight sm:text-6xl">A fresh start begins<br /><span className="text-[#d3b995]">with a conversation.</span></h1><p className="mt-6 max-w-xl text-lg leading-relaxed text-zinc-300">Whether you’re exploring removal or making room for a cover-up, start by understanding your options.</p><Link href="/book?service=removal" className="studio-button mt-8">Request a removal consultation <ArrowUpRight size={18} /></Link><p className="mt-4 text-sm text-zinc-400">Free consultation at any of our studios. No payment needed.</p></div>
